...
class UserRepository:
    ...
    def save_voice_enrollment(
        ...
        """
        Lưu voice enrollment: chỉ lưu embedding vector + metadata vào DB.
        ...
        try:
            ...
            if result.rowcount > 0:
                logger.info(
                    f"✅ Saved voice enrollment for user {user_id} | lang={language}"
                )
                ...
                if backup_service:
                    ...
                    if user:
                        backup_service.save_user({
                            ...
                            "voice_key_text":   voice_key_text,
                            "voice_language":   language,
                            "voice_registered_at": datetime.utcnow().isoformat(),
                            # embedding không backup (binary lớn)
                        })
